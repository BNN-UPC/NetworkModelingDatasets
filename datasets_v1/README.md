...
This repository contains datasets with simulation results of delay, jitter and packet loss in four different network topologies. It is divided in four compressed files (.tar.gz) corresponding to each topology. Each file follows the structure below:
